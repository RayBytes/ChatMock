"""Non-stream Chat Completions should include usage when upstream provides it."""
...
def test_openai_nonstream_includes_usage(client: object, monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
    ...
    data = resp.get_json()
    assert resp.status_code == 200 and data.get("usage", {}).get("total_tokens") == 3
