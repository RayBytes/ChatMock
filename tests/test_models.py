...
class ModelRegistryTests(unittest.TestCase):
    def test_normalizes_aliases(self) -> None:
        ...
        self.assertEqual(normalize_model_name("gpt-5.6-terra-latest"), "gpt-5.6-terra")
        self.assertEqual(normalize_model_name("gpt-5.6-luna"), "gpt-5.6-luna")
    ...
    def test_strips_reasoning_suffixes(self) -> None:
        ...
        self.assertEqual(normalize_model_name("gpt-5.1-codex:max"), "gpt-5.1-codex")
    ...
    def test_allowed_efforts_follow_registry(self) -> None:
        ...
        gpt_56_efforts = frozenset(("none", "low", "medium", "high", "xhigh", "max"))
        self.assertEqual(allowed_efforts_for_model("gpt-5.6-sol"), gpt_56_efforts)
        self.assertEqual(allowed_efforts_for_model("gpt-5.6-terra"), gpt_56_efforts)
        self.assertEqual(allowed_efforts_for_model("gpt-5.6-luna"), gpt_56_efforts)
    ...
    def test_public_models_include_variants(self) -> None:
        ...
        self.assertIn("gpt-5.6-sol-none", model_ids)
