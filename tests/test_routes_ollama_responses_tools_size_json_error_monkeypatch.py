"""Force TypeError in json.dumps(extra_tools) to hit size-except path in Ollama route."""
...
def test_ollama_responses_tools_size_json_error_monkeypatch(
    ...
    resp = client.post("/api/chat", data=_json.dumps(body), content_type="application/json")
